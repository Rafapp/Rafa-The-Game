...
function Cover(){
    return(
        <div id='home' style={{display: 'flex', position:"relative", justifyContent:'center', alignItems:'center', height: 'auto', width: 'auto', paddingTop:"91px"}}>
            <div style={{overflowX:"hidden",backgroundColor:"black", position:'relative', top:0, left:0}}>
                ...
                <h1 style={{position:"absolute", textAlign:"center", top:"30%", left:"50%", transform: "translate(-50%, -50%)", background:"linear-gradient(to right, #FF5F6D 0%, #FFC371 100%)",WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent", fontSize:"7vw", whiteSpace:"nowrap", clipPath:"inset(1px)"}}>Rafael Padilla Perez</h1>
