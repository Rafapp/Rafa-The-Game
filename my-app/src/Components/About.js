...
function About(){
    return(
        <div id="about" bg='dark' style={{position:"relative", paddingTop:"60%", background:"linear-gradient(to bottom, hsla(0, 0%, 0%, 1) 0%, hsla(0, 0%, 13%, 1) 100%)"}}>
            <h1 style={{position:"absolute", textAlign:"center", top:"15%", left:"25%", transform: "translate(-50%, -50%)", background:"linear-gradient(to right, #FF5F6D 0%, #FFC371 100%)",WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent",fontSize:"7vw", whiteSpace:"nowrap"}}>About me</h1>
