...
function About(){
    return(
        <div id="about" bg='dark' style={{position:"relative", paddingTop:"60%", background:"linear-gradient(to bottom, #1e2124 50%, #282b30 100%"}}>
            <h1 style={{position:"absolute", textAlign:"center", top:"15%", left:"25%", transform: "translate(-50%, -50%)", background:"linear-gradient(to right, #ef32d9 0%, #89fffd 100%)",WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent",fontSize:"7vw", whiteSpace:"nowrap"}}>About me</h1>
